...
public class FilterBuilder {
	...
	private static List<Filter> defaults() {
		...
		AccessCondition allowPlayers = new AccessCondition("allow-players", State.ALLOW, null);
		...
		WorldCondition allowBlocks = new WorldCondition("allow-blocks", State.ALLOW);
		...
		BlockCondition allowWorld = new BlockCondition("allow-world", State.ALLOW, null);
		...
		EntityCondition allowEntities = new EntityCondition("allow-entities", State.ALLOW, null);
